  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.image) {
      Swal.fire({
        icon: "warning",
        title: "ছবি নেই!",
        text: "দয়া করে Banner Image upload করুন।",
    ...
    if (!formData.title.trim()) {
      Swal.fire({
        icon: "warning",
        title: "Title নেই!",
        text: "দয়া করে Banner Title লিখুন।",
        confirmButtonColor: "#7e22ce",
      });
    ...
    if (!formData.subtitle.trim()) {
      Swal.fire({
        icon: "warning",
        title: "Subtitle নেই!",
        text: "দয়া করে Banner Subtitle লিখুন।",
        confirmButtonColor: "#7e22ce",
      });
    ...
    try {
      ...
      await Swal.fire({
        icon: "success",
        title: "সফল!",
        text: "Banner সফলভাবে যোগ করা হয়েছে।",
        confirmButtonColor: "#7e22ce",
        ...
        <div className="rounded-2xl border border-purple-100 bg-white p-6 shadow-xl shadow-purple-50 sm:p-8">
          ...
          <div className="mb-7 border-b border-gray-100 pb-5">
            ...
            <p className="mt-1 text-sm text-gray-500">
              আপনার ওয়েবসাইটের জন্য নতুন Banner
              তৈরি করুন।
            </p>
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                required
                placeholder="যেমন: আপনার পছন্দের জার্সি"
            ...
            <div>
              ...
              <textarea
                ...
                required
                rows="3"
                placeholder="যেমন: আপনার পছন্দের জার্সি অর্ডার করুন সেরা দামে।"
                className="w-full resize-none rounded-xl border border-purple-200 bg-purple-50/40 px-4 py-3 text-sm outline-none transition focus:border-purple-500 focus:bg-white focus:ring-2 focus:ring-purple-100"
              />
